...
- Usada para definir ou modificar a estrutura do banco de dados.
  ...
  - [Saber mais](/introdução%20SQL/tipos%20de%20linguagem/DDL.md)
...
- Usada para gerenciar dados dentro das tabelas.
  ...
  - [Saber mais](/introdução%20SQL/tipos%20de%20linguagem/DML.md)
...
[Próxima página](anatomia_declaracao.md) |  [Página anterior](o_que_e.md)
